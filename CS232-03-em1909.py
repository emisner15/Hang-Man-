...
os.chdir("C:\\Users\\Eric\\Desktop\\hangman")
...
def word_guessed():
    ...
    ####### YOUR CODE HERE ######
    # This tells Python to skip this function for now
    # delete "pass" when you start working on this function


# print_guessed: void -> void
# expects nothing, returns nothing
# side effect: prints to the screen (on one line) the letters
# of the secret word that have been guessed, and "_" for the
# letters that haven't yet been guessed
    ...
    while wrong_guesses < 6:
        ...
        if guess in 'abcdefghijklmnopqrstuvwxyz':
            if guess not in letters_guessed:
                ...
                if wrong_guesses >=6:
                    print()
                    print('You lose, the secretword is: ', secret_word)
                    letters_guessed = []
